...
public class ItemDetailsModel {
    ...
    public ItemDetailsModel(String item_category_id, String item_description, boolean item_for_sale, boolean item_is_per_sqr_unit_of_measurement, String item_name, double item_price, String item_price_description, String item_store_id, String item_uid) {
